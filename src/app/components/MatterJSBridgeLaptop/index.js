...
// styles
import styles from './MatterJSBridgeLaptop.module.css'

const THICCNESS = 60;
const RATIO = 0.11;

const MatterJSBridgeLaptop = () => {
  ...
  useEffect(() => {
    ...
    const bridge = Composites.stack(100, 100, 8, 1, 0, 1, function(x, y) {
      return Bodies.rectangle(x - 10, y, canvasWidth - ((canvasWidth * (RATIO * 2)) * 2.8), 40, { 
...
export default MatterJSBridgeLaptop;